...
\section{Solution}
\begin{lemma}
Two events A and B are said to be independent if and only if P(AB)=P(A)P(B). \label{l1}
\end{lemma} 
When a die is thrown the possibilities are
$S=\{1,2,3,4,5,6\}$.Based on this the description of events are given in table \ref{tab:table1}
