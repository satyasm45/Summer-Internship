...
\end{align}
This matrix equation can be solved for different values of $\beta$ to find $\lambda_1$ and $\lambda_2$ which are both positive and also satisfying the constraint  that X-axis is the major axis.This was done using python and some ellipses are shown in  \ref{fig:ellipses}
